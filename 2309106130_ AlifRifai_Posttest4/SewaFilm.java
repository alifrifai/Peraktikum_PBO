...
class Admin extends User {
    ...
    /* POLYMORPHISM: Override method login() dari parent class */
    @Override
...
// Abstract class Transaksi sebagai parent class
abstract class Transaksi {
    ...
    /* POLYMORPHISM: 
       Method displayDetails() akan di-override oleh subclass */
...
class Penyewaan extends Transaksi {
    ...
    /* POLYMORPHISM: Override method displayDetails() dari parent class */
    @Override
...
public class SewaFilm {
    ...
    // Versi 1: Tanpa parameter (menampilkan semua film)
    ...
    // Versi 2: Dengan parameter genre (menampilkan film berdasarkan genre)
    ...
    static void menuCustomer() {
        while (true) {
            ...
            switch (pilihan) {
                case 1: 
                    lihatFilm(); // Memanggil versi tanpa parameter
                    break;
                case 2: 
                    System.out.print("Masukkan genre film: ");
                    String genre = input.nextLine();
                    lihatFilm(genre); // Memanggil versi dengan parameter
                    break;
    ...
    static void tambahPenyewaan() {
        ...
        System.out.println("\n=== DETAIL TRANSAKSI ===");
        penyewaanBaru.displayDetails(); // Polymorphism: memanggil method override
        pembayaranBaru.displayDetails(); // Polymorphism: memanggil method override
